...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Launch MORL BOPTEST fine-tuning from the calibrated 15-minute v3.5 surrogate-pretrained checkpoint."
    )
    _, extra_args = parser.parse_known_args()

    cmd = build_command(extra_args)
    print("MORL fine-tune from 15-minute v35_calibrated pretrain")
    print("Command:")
