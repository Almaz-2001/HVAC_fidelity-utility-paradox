...
def main() -> None:
    ...
    rows = [
        ...
        dict(y=0.18, c=BLUE, ncurve=n_v3, shape="smooth + censored",
             ...
             status="ROBUST", outcome=f"$m_s$={m['hybrid_typ']:.3f} typ. · viol <5% · {N['speedup']:.0f}× faster"),
    ]
